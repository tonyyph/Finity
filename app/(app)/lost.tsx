  ...
  return (
    <View style={tw`flex-1 bg-white`}>
      ...
      <View style={tw`flex-1`}>
        ...
        <View style={tw`px-sp16 gap-sp24`}>
          <Button.Primary isLoading={loading} loadingTitle="Confirming.." title={'Confirm and request card'} onPress={handleConfirm} />
        </View>
