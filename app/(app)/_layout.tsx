...
import {exactDesign, tw} from '@/utils'
...
export default function AuthenticatedLayout() {
  ...
  return (
    <View style={tw`flex-1`}>
      {shouldPINLocal && <AuthLocal onAuthenticated={() => setShouldPINLocal(false)} />}
      <Stack
        screenOptions={{
          headerShown: true,
        ...
        />
        <Stack.Screen name="success-phonenumber" options={{headerShown: false}} />
        <Stack.Screen name="success-homeaddress" options={{headerShown: false}} />
        ...
        <Stack.Screen name="edit-phonenumber" options={{headerShown: false}} />
