import {activeCard, getCardHolderCurrent, getCardHolders, handleFreeze, handleUnFreeze, reportOrDamageCard, requestCard} from '@/api'
...
export const useCardHolder = () => {
  ...
  const {showBottomSheetPin, setShowBottomSheetPin, setPinInfo, pinInfo} = useUserAuthenticateStore()
  ...
  const handleFreezeCard = async () => {
    ...
    console.log('data?.cardStatus', data?.cardholderId)
    try {
