import {SCREEN_HEIGHT, SCREEN_WIDTH, tw} from '@/utils'
            ...
            renderTabBarItem={props => (
              <TabBarItem
                ...
                label={({route, focused, color}) => (
                  <Typography weight={focused ? 'bold' : 'medium'} textColor={color} style={tw`px-sp12 w-40 text-center`}>
                    {route.title}
                  </Typography>
                )}
                activeColor={'#0A0A0A'}
