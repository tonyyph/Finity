import { getPlanConfig } from "@finity/utilities";
import type { CreateWallet, UpdateWallet } from "@finity/validation";
...
export async function deleteWallet({ walletId }: { walletId: string }) {
