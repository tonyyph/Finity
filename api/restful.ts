...
export const refreshToken = async (data: RefreshTokenRequest) => {
  return await axios.post<RefreshTokenResponse>(`${process.env.EXPO_PUBLIC_API_URL}/auth/refresh-token`, {
...
export const getUserProfile = async () => {
  const token = await clerk.session?.getToken()
  return await axios.get<UserResponse>(`${process.env.EXPO_PUBLIC_API_URL}/user`, {
    headers: {
      Accept: 'application/json',
      'Accept-Encoding': 'gzip, deflate, br, zstd',
      'Accept-Language': 'en-US,en;q=0.9',
...
export const getSettingProfile = async () => {
  const token = await clerk.session?.getToken()
  return await axios.get<UserValue>(`${process.env.EXPO_PUBLIC_API_URL}/settings/profile`, {
    headers: {
      Accept: 'application/json',
      'Accept-Encoding': 'gzip, deflate, br, zstd',
      'Accept-Language': 'en-US,en;q=0.9',
...
export const getCardHolderCurrent = async () => {
  const token = await clerk.session?.getToken()
  return await axios.get<UserCardInfo>(`${process.env.EXPO_PUBLIC_API_URL}/cardholders/current`, {
    headers: {
      Accept: 'application/json',
      'Accept-Encoding': 'gzip, deflate, br, zstd',
      'Accept-Language': 'en-US,en;q=0.9',
...
export const getCardTransaction = async (data: ListTransactionRequest) => {
  ...
  return axios.get<ListTransactionResponse>(`${process.env.EXPO_PUBLIC_API_URL}/account/paginated-card-transactions`, {
    headers: {
      Accept: 'application/json',
      Authorization: `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export const getListFAQ = async () => {
  ...
  return axios.get<ListTransactionResponse>(`${process.env.EXPO_PUBLIC_API_URL}/faq`, {
    headers: {
      Accept: 'application/json',
      Authorization: `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export const getCardHolders = async () => {
  ...
  return axios.get<UserCardHolder[]>(`${process.env.EXPO_PUBLIC_API_URL}/cardHolders/get-cardholders`, {
    headers: {
      Accept: 'application/json',
      'Accept-Encoding': 'gzip, deflate, br, zstd',
      'Accept-Language': 'en-US,en;q=0.9',
...
export const getConfirmationDetails = async (transactionId: number) => {
  ...
  try {
    return await axios.get(`${process.env.EXPO_PUBLIC_API_URL}/accounts/get-confirmation-details/${transactionId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': 'application/json',
        'X-DeviceId': deviceId,
    ...
    console.error('❌ getConfirmationDetails error:', err?.response?.data || err.message)
    throw err
  }
}
...
export const getPersonalPoints = async () => {
  ...
  try {
    return await axios.get(`${process.env.EXPO_PUBLIC_API_URL}/PersonalPoints`, {
      headers: {
        Authorization: `Bearer ${token}`,
        'Content-Type': 'application/json',
        'X-DeviceId': deviceId,
    ...
    console.error('❌ getPersonalPoints error:', err?.response?.data || err.message)
    throw err
  }
}
